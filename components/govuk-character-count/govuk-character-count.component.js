import componentStyles from './govuk-character-count.styles';
import { CharacterCount } from './govuk-character-count.script';

import { TextAreaComponent } from '../govuk-textarea/govuk-textarea.component';
...
customElements.define('govuk-character-count', CharacterCountComponent);
